package com.rgk.pran.ui.screen.screen_4
...
import com.rgk.pran.ui.components.LottieImageComponent
import com.rgk.pran.ui.components.TypewriterTextComponent
import com.rgk.pran.ui.config.Utils

@SuppressLint("ResourceType")
@Composable
fun ScreenFourth(onYesClick: () -> Unit,onNoClick: () -> Unit,onBackClick:() -> Unit) {
    ...
    Box(
        ...
        Column(
            ...
            LottieImageComponent(
                rawRes = R.raw.inside_out_2,
            ...
            AnimatedVisibility(
                ...
                Column( horizontalAlignment = Alignment.CenterHorizontally,
                    ...
                    CustomButton(onClick = onYesClick) {
                        Text(Utils.BUTTON_PAGE_4_YES)
                    }
                    Spacer(modifier = Modifier.height(10.dp))
                    CustomButtonOutline(onClick = onNoClick) {
                        Text(Utils.BUTTON_PAGE_4_NO)
                    }
                }
            }
